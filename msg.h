...
#define MAIN_MSG_GUEST_REQ "The main server received the guest request for %s using TCP over port %d.\nThe main server accepts %s as a guest.\n"
...
#define CLIENT_MSG_AVAILABLE_RESP "The client received the response from the main server using TCP over port %d. \nThe requested room is available.\n\n-----Start a new request-----\n"
#define CLIENT_MSG_NOT_AVAILABLE_RESP "The client received the response from the main server using TCP over port %d. \nThe requested room is not available.\n\n-----Start a new request-----\n"
#define CLIENT_MSG_AVAILABILITY_NO_ROOM "The client received the response from the main server using TCP over port %d. \nNot able to find the room layout.\n\n-----Start a new request-----\n"
...
#define MEMBER_MSG_RESERVE_SUC "The client received the response from the main server using TCP over port %d. \nCongratulation! The reservation for Room %s has been made. \n\n-----Start a new request-----\n"
#define MEMBER_MSG_RESERVE_FAIL "The client received the response from the main server using TCP over port %d. \nSorry! The requested room is not available.\n\n-----Start a new request-----\n"
#define MEMBER_MSG_RESERVE_NO_ROOM "The client received the response from the main server using TCP over port %d. \nOops! Not able to find the room.\n\n-----Start a new request-----\n"
...
#define CLIENT_INVALID_INPUT_SPACE "Error: input has spaces\n"